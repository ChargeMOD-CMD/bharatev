...
function AboutPage() {
  return (
    <main className="pt-28 md:pt-36">
      ...
      {/* Managing Director Section — TOP */}
      <section className="border-t border-border/70 bg-card/30 px-4 py-16 md:py-24">
        <div className="mx-auto max-w-7xl">
          ...
          <Reveal delay={0.15}>
            <div className="mx-auto mt-14 flex max-w-3xl flex-col items-center gap-10 rounded-2xl border border-border bg-card p-10 shadow-lg md:flex-row md:gap-14">
              {/* Photo */}
